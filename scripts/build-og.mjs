...
const cards = [
  ...
  },
  {
    ...
    headline: "Score your personal brand.",
    headlineSize: 60,
    subhead: "Five pillars, one written Operational Transcript in 72 business hours.",
  ...
  },
  {
    ...
    labelSub: "",
    eyebrowRight: "FOUNDATION SCORE",
    headline: "Document the career.",
    headlineSize: 60,
    subhead: "Portfolio, proof, and public credibility — scored in 72 business hours.",
    footerTag: "72-HOUR TRANSCRIPT",
  },
];
